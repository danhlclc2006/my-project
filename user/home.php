...
<head>
    <meta charset="UTF-8">
    <title>XSHOP Plus - Trang chủ</title>
...
<main class="container my-4">
    ...
    <div id="carouselExampleIndicators" class="carousel slide mb-4" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="../uploads/20.jpg" class="d-block w-100" alt="Banner 1">
            </div>
            <div class="carousel-item">
                <img src="../uploads/21.jpg" class="d-block w-100" alt="Banner 2">
            </div>
        </div>
    </div>
    ...
    <section class="mb-5">
        ...
        <div class="row">
            ...
            $products = get_sanpham_by_category($dm['id'], 4);
